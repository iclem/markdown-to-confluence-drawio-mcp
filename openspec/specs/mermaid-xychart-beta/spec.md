# Mermaid Xychart Beta Specification

## Purpose
Define how supported Mermaid `xychart-beta` diagrams are converted into draw.io-ready explicit-layout diagrams and published through the existing markdown workflow.
